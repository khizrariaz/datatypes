...
var chef = [{ chefOne: chefOne }, { chefTwo: chefTwo }, { chefThree: chefThree }], chefNames = [chefOne.fullName, chefTwo.fullName, chefThree.fullName], classId = [chefOne.rollNo, chefTwo.rollNo, chefThree.rollNo];
