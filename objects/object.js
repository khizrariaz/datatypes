...
var student = [{ student1: student1 }, { student2: student2 }, { student3: student3 }], studentNames = [student1.fullName, student2.fullName, student3.fullName], classId = [student1.rollNo, student2.rollNo, student3.rollNo];
console.log(student);
